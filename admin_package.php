                      ...
                      <div class="modal-body">
                        <form class="forms-sample" action="" method="post">
                            <div class="form-group">
                              <label >Package</label>
                              <input type="text" name="pack_name" class="form-control" autocomplete="off">
                            </div>
                ...
                <div class="table-responsive">
                  ...
                  if (sqlsrv_has_rows($result) == 0) {
                      ...
                      while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                          ...
                          echo "<td class='text-center mt-3'><a class=btn btn-primary href=admin_package_edit.php?pack_id=".$row['pack_id']."><i class=ti-eraser></i></a></td>";
                          echo "<td class='text-center mt-3'><a class='btn btn-delete btn_del' href=admin_package_del.php?pack_id=".$row['pack_id']."><i class=ti-trash></i></a></td>";
                          echo "</tr>";         
                    }
                  }
                  echo "</tbody>";
                  ...
                  ?>
                    <div class="modal-footer">
                    <a href="admin_material.php" class="btn btn-primary">Next</a>
                    </div>
                  </div>
                </div>
              </div>
