                        ...
                        <div class="form-group row">
                          <div class="card-body">
                            ...
                            <ul class="bullet-line-list">
                              <li>
                              <a href="measurement_list.php" style="text-decoration: none;">
                                <div><span class="text-light-green" style="font-size: 20px; color: navy;"><b>In Progress</b></span></div>
                              </a>
                              </li>
                              <li>
                                <a href="measurement_list_complete.php" style="text-decoration: none;">
                  ...
                  <table id="datatableid" class="table table-sm table-bordered">
                    ...
                    <tbody>
                      ...
                      while ($row = sqlsrv_fetch_array($result,SQLSRV_FETCH_ASSOC)) {
                              ...
                              echo "<td class='text-center mt-3'><a class=btn btn-primary href=measure_add.php?measure_id=".$row['measure_id']."&id=".$row['id']."><i class=ti-pencil></i></a></td>";
                              echo "<td class='text-center mt-3'><a class='btn btn-delete btn_del' href=measure_del.php?measure_id=".$row['measure_id']."><i class=ti-trash></i></a></td>";
                              echo "</tr>";
                          }
                        }
                      ?>
