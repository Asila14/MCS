                    ...
                    <tbody>
                      ...
                      for ($b = 1; $b <= $spec_correction; $b++) {
                        ...
                        <td class='text-center mt-3'>
                          <button href="admin_measure_form.php" class="btn btn-outline-primary btn-icon-text" type="button" name="attempt<?php echo $b; ?>" onclick="window.location.href = 'admin_measure_form.php?attempt=<?php echo $b; ?>&measure_id=<?php echo $row['measure_id']; ?>&spec_id=<?php echo $row['spec_id']; ?>&item_id=<?php echo $row['item_id']; ?>&id=<?php echo $row['id']; ?>';"><i class="ti-file btn-icon-prepend"> Attempt <?php echo $b; ?> </i>
                          </button>
                        </td>
                      </tr>
                        <?php
