            ...
            <div class="col-12 grid-margin">
              <div class="card">
                ...
                if (isset ($_POST['add'])){
                    ...
                    // Check if the user_emp and process_id values already exist in the database
                    $sql = "SELECT * FROM users WHERE user_emp  LIKE '%$user_emp%'";
                    $result = sqlsrv_query($con,$sql);

                    // If the user_emp and process_id values already exist in the database, show an error message
                    if (sqlsrv_has_rows($result) > 0) {
                        ...
                        // The user_emp and process_id values do not exist in the database, so insert the new data
                ...
                <div class="modal fade" id="AddUsers" tabindex="-1" aria-labelledby="AddUsersLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="forms-sample" action="" method="POST">
                            ...
                            <div class="form-group">
                              <label >Level</label>
                              <select data-live-search="true" name="user_level" class="form-control selectpicker">
                            ...
                            <div class="form-group">
                              ...
                              <select data-live-search="true" name="user_position" class="form-control selectpicker">
                            ...
                            <div class="form-group">
                              ...
                              <input class="typeahead" id="psw" type="text" autocomplete="off" name="user_password"
                                       class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required>
                            </div>
                  ...
                  $sql = "SELECT * FROM users inner join process ON users.process_id=process.process_id WHERE user_level IN ('User','Admin') ORDER BY process_name ASC";
                  ...
                  if (sqlsrv_has_rows($result) == 0) {
                      ...
                      while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                          echo "<tr>";
                                ...
                                echo "<td class='text-center mt-3'><a class=btn btn-primary href=user_edit.php?user_emp=".$row['user_emp']."><i class=ti-eraser></i></a></td>";
                                echo "<td class='text-center mt-3'><a class='btn btn-delete btn_del' href=user_del.php?user_emp=".$row['user_emp']."><i class=ti-trash></i></a></td>";
                                echo "</tr>";             
                    }
                  }
                  echo "</tbody>";
                  ...
                  ?>
                    <div class="modal-footer">
                    <a href="machine.php" class="btn btn-primary">Next</a>
                    </div>
                  </div>
                </div>
              </div>
