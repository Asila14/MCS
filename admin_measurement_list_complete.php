                          ...
                          <div class="card-body">
                            ...
                            <ul class="bullet-line-list">
                              ...
                              <a href="admin_measurement_list.php" style="text-decoration: none;">
                                <div><span class="text-light-green">In Progress</span></div>
                              </a>
                              </li>
                              <li>
                                <a href="admin_measurement_list_complete.php" style="text-decoration: none;">
                                  <div><span class="text-light-green" style="font-size: 20px; color: navy;"><b>Complete</b></span></div>
                              </a>
                              </li>
                            </ul>
                  ...
                  <table id="datatableid" class="table table-sm table-bordered">
                    ...
                    <tbody>
                      ...
                      <?php
                       ...
                       $sql = "SELECT * FROM complete_lot
                              INNER JOIN measurement ON measurement.measure_id=complete_lot.measure_id 
                              INNER JOIN process ON process.process_id=measurement.process_id 
                              INNER JOIN partnumber ON partnumber.id=measurement.id 
                              WHERE measure_datetime >= datefromparts(year(getdate()), month(getdate()), 1) AND process.process_id='$process_id'
