                ...
                <div class="modal fade" id="Addpartnumber" tabindex="-1" aria-labelledby="AddpartnumberLabel" aria-hidden="true">
                        ...
                        <form class="forms-sample" action="" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <?php
                                    ...
                                    $mate = sqlsrv_query($con,"SELECT * FROM material WHERE process_id='$process_id' ");
                              ?>
                  ...
                  if (sqlsrv_has_rows($result) == 0) {
                      ...
                      while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                          ...
                          echo "<td class='text-center mt-3'><a class=btn btn-primary href=admin_partno_edit.php?id=".$row['id']."><i class=ti-eraser></i></a></td>";
                          echo "<td class='text-center mt-3'><a class='btn btn-delete btn_del' href=admin_partno_del.php?id=".$row['id']."><i class=ti-trash></i></a></td>";
                          echo "</tr>";      
                    }
                  }
                  echo "</tbody>";
                  ...
                  ?>
                    <div class="modal-footer">
                    <a href="admin_spec.php" class="btn btn-primary">Next</a>
                    </div>
                  </div>
                </div>
              </div>
