            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="export.php" id="export-button" name="export" class="btn btn-success">Export to Excel</a>
                  <a href="export_CSV.php" id="export-button" name="export" class="btn btn-warning">Export to CSV</a>
                    </div>
