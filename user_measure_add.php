                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      <thead>
                        ...
                        echo "<tr>";
                        echo "<td class='text-center mt-3'><a class=btn btn-primary href=user_measure_manage1.php?id=".$rows['id']."&item_id=".$rows['item_id']."&spec_id=".$row['spec_id']."&measure_id=".$rows['measure_id']."><i class=ti-pencil></i></a></td>";
