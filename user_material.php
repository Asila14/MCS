              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="col-md-6">
                  <h4 class="card-title">Registered Material</h4>
                  <!-- Modal -->
                <?php
                  ...
                  <div class="table-responsive">
                    <table id="datatableid" class="table table-sm table-bordered">
                      ...
                      <tbody class="table table-sm">
                        ...
                        $sql1 = "SELECT * FROM material inner join process ON material.process_id=process.process_id WHERE process.process_id=$process_id ";
                    ...
                    <div class="modal-footer">
                    <a href="user_partno.php" class="btn btn-primary">Next</a>
                    </div>
                  </div>
                </div>
              </div>
