        ...
        <div class="content-wrapper">
          <div class="row">
                  ...
                  <form class="forms-sample" action="" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <a href="index_list.php" class="btn btn-secondary">Back</a>
                        <input type="hidden" name="measure_id" value="<?php echo $row['measure_id']; ?>">
                        <button type="submit" name="adds" class="btn btn-primary">Validate</button>
                  </form>
                </div>
              </div>
            </div>
            ...
            <?php
                ...
                if (isset($_POST['adds']) && isset($_POST['measure_id'])) 
                {
                    ?>
