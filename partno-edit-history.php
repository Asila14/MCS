              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="col-md-10">
                  <h4 class="card-title">Part Number History</h4>
                  <div class="table-responsive">
                  <?php
                    include 'includes/connect.php';

                    // Fetch records from the database with pagination
                    $sql = "SELECT * FROM edited_partnumber 
                        INNER JOIN process ON edited_partnumber.process_id=process.process_id  
                        INNER JOIN customer ON edited_partnumber.cust_id=customer.cust_id 
                        INNER JOIN package ON edited_partnumber.pack_id=package.pack_id 
                        INNER JOIN material ON edited_partnumber.material_id=material.material_id 
                        ORDER BY edited_date DESC"; // Corrected ORDER BY clause
                    ...
                    if (sqlsrv_has_rows($result) == 0) {
                        ...
                        while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                            ...
                            echo "<td class='text-center mt-3'>".$row['edited_date']->format('Y-m-d H:i:s')."</td>";
                            echo "</tr>";     
                        }
                    }
                    echo "</tbody>";
