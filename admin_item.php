              ...
              <div class="card">
                ...
                if (isset ($_POST['addItem'])){
                  // Get the user's employee number from the session variable.
                    ...
                    $sql = "INSERT INTO item (item_name,item_code,process_id) VALUES ('$item_name','$item_code','$process_id')";
                ...
                <div class="modal fade" id="AddItem" tabindex="-1" aria-labelledby="AddItemLabel" aria-hidden="true">
                  ...
                  <div class="table-responsive">
                    <?php
                        ...
                        $sql = "SELECT * FROM item inner join process ON item.process_id=process.process_id WHERE process.process_id='$process_id' ORDER BY item_name ASC ";
                        $result = sqlsrv_query($con, $sql) or die('Database connection error');
                        ...
                        if (sqlsrv_has_rows($result) == 0) {
                            ...
                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                                ...
                                echo "<td class='text-center mt-3'><a class=btn btn-primary href=admin_item_edit.php?item_id=".$row['item_id']."><i class=ti-eraser></i></a></td>";
                                echo "<td class='text-center mt-3'><a class='btn btn-delete btn_del' href=admin_item_del.php?item_id=".$row['item_id']."><i class=ti-trash></i></a></td>";
                                echo "</tr>";               
                            }
                        }
                        ...
                        ?>
                    <div class="modal-footer">
                    <a href="admin_customer.php" class="btn btn-primary">Next</a>
                    </div>
                  </div>
                </div>
              </div>
