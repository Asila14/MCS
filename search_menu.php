                          ...
                          <div class="col-sm-9">
                            <?php
                                ...
                                $machinesQuery = sqlsrv_query($con, "SELECT DISTINCT machine.mc_id, machine.mc_name, machine.process_id, process.process_name 
                                                                      FROM machine INNER JOIN process ON machine.process_id = process.process_id ORDER BY process.process_name ASC");
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                if (isset($_POST['table'])) {
                    ...
                    $query = "SELECT * FROM spec_result
                        ...
                        INNER JOIN item ON spec_result.item_id = item.item_id
