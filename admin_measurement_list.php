                        ...
                        <div class="form-group row">
                          <div class="card-body">
                            ...
                            <ul class="bullet-line-list">
                              <li>
                              <a href="admin_measurement_list.php" style="text-decoration: none;">
                                <div><span class="text-light-green" style="font-size: 20px; color: navy;"><b>In Progress</b></span></div>
                              </a>
                              </li>
                              <li>
                                <a href="admin_measurement_list_complete.php" style="text-decoration: none;">
                ...
                <div class="table-responsive">
                  <table id="datatableid" class="table table-sm table-bordered">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT measurement.measure_id, measurement.id, measurement.process_id, measurement.measure_emp, measurement.measure_lot, measurement.measure_datetime, process.process_name, partnumber.pn_no, complete_lot.measure_id AS c_measure_id, complete_lot.id AS c_id FROM measurement LEFT JOIN complete_lot ON measurement.measure_id = complete_lot.measure_id AND measurement.id = complete_lot.id INNER JOIN process ON process.process_id = measurement.process_id INNER JOIN partnumber ON partnumber.id = measurement.id WHERE complete_lot.measure_id IS NULL AND complete_lot.id IS NULL AND process.process_id='$process_id' ORDER BY measurement.measure_datetime DESC";
                      ...
                      while ($row = sqlsrv_fetch_array($result,SQLSRV_FETCH_ASSOC)) {
                              ...
                              echo "<td class='text-center mt-3'><a class=btn btn-primary href=admin_measure_add.php?measure_id=".$row['measure_id']."&id=".$row['id']."><i class=ti-pencil></i></a></td>";
                              echo "<td class='text-center mt-3'><a class='btn btn-delete btn_del' href=admin_measure_del.php?measure_id=".$row['measure_id']."><i class=ti-trash></i></a></td>";
                              echo "</tr>";
                          }
                        }
                      ?>
