...
$sql = "SELECT * FROM deleted_specification 
        INNER JOIN partnumber ON deleted_specification.id = partnumber.id 
        INNER JOIN process ON process.process_id = partnumber.process_id 
        INNER JOIN item ON deleted_specification.item_id = item.item_id 
        INNER JOIN users ON users.user_emp = deleted_specification.user_emp 
